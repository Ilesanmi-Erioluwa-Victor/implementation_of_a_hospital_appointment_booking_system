<div class="container py-4">
    ...
    <div id="loginPrompt" class="d-none">
        <div class="card auth-card p-5 text-center">
            ...
            <p class="text-muted">You need to be logged in to book an appointment.</p>
            <a href="/login?redirect=/book" class="btn btn-primary btn-lg px-5">Login Now</a>
            <p class="mt-3 mb-0"><a href="/register?redirect=/book">Don't have an account? Register</a></p>
        </div>
    </div>
    <div id="bookingFormWrapper" class="d-none">
        <div class="row">
            <div class="col-lg-8">
                <div class="card p-4">
...
(function() {
    ...
    document.getElementById('loginPrompt').classList.toggle('d-none', !!token);
    document.getElementById('bookingFormWrapper').classList.toggle('d-none', !token);
})();
</script>
